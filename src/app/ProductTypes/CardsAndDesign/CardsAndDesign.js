...
export default function CardsAndDesign() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const data =
          await client.fetch(`*[_type == "product" && category == "cardsAndDesign"]{
          _id,
          title,
          description,
          price,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">
            Premium and creative designs tailored for you
          </p>
        </div>
          ...
          >
            ...
            {products.length === 0 && (
              <div className="w-full text-center text-gray-500 py-16">
                No Cards & Design products found — add some in Sanity Studio.
              </div>
            )}
          </div>
        </div>
